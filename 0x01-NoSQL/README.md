...
Potential issue if documents creation doesn’t work or this error:   *` Data directory /data/db not found., terminating `*   ( **[source](https://intranet.hbtn.io/rltoken/RuEv46l7OtXQZ3doQD7vjw)** 
